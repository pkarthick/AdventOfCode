...
for s in input.split('\n'): 
    ...
    sm.addOrbiter(objId, orbiterId)

var you = sm.getOrCreate("YOU").objects.mapIt(it.id).toHashSet
var san = sm.getOrCreate("SAN").objects.mapIt(it.id).toHashSet
let common = you * san
echo len((you - common) + (san - common))
