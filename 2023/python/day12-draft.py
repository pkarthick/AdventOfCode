...
def number_of_arrangements(s: str, sizes: List[int], start: int, count: int) -> int:
...
for lin in lines:
    ...
    num = number_of_arrangements(s, sizes, 0, 0)
    count += num
    ...
    # arrange(record.pattern, sizes, 0, s)
    
    # print(s)
    
    # print()
    # print(f"{record.pattern} {record.sizes} -> {record.arrangement_count} {record.resolved}")
    # print()
